...
public class Basket {
	...
	private int shoppingNo; // 장바구니 일련번호
	...
	public Basket() {}
	public Basket(int pno, int userNo, int shoppingNo, int cartAmount, String shoppingStatus, String pthumbnailUrl,
	...
	public String toString() {
		return "Basket [pno=" + pno + ", userNo=" + userNo + ", shoppingNo=" + shoppingNo + ", cartAmount=" + cartAmount
