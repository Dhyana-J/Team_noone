...
public class Member {
	...
	public Member(int userNo, String userId, String userPwd, String userName, String email, String phone,
			String address, String addressDetail, int addressCode, String delete, String manager, int reportAmount) {
		super();
		this.userNo = userNo;
		this.userId = userId;
	...
	public String toString() {
		return "Member [userNo=" + userNo + ", userId=" + userId + ", userPwd=" + userPwd + ", userName=" + userName
				...
				+ ", addressCode=" + addressCode + ", delete=" + delete + ", manager=" + manager + ", reportAmount="
				+ reportAmount + "]";
	}
