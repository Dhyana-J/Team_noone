    ...
    <%if(alertMsg!=null){ %>
      ...
      <div class="header">
	      ...
	      <div id="profile">
	        ...
	        <div id="welcome"><%=loginUser.getUserId()%>님<br>환영합니다⬇</div>
	      </div>
      ...
      <div class="navigator">
		  <div class="mainMenu"><a href="">홈</a></div>
	      <div class="mainMenu"><a href="">스토어</a></div>
...
<script src="<%=contextPath%>/resources/js/navigator.js"></script>
</body>
</html>