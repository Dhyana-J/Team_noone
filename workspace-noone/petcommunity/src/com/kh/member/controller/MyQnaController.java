...
/**
 * Servlet implementation class MyQnaController
 */
@WebServlet("/myQna.me")
public class MyQnaController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		listCount = new MemberService().selectMyQnaCount(userNo);
		...
		ArrayList<MyQna> list = new MemberService().selectMyQnaList(userNo,pi,sortOption);
		
		request.setAttribute("pi", pi);
		request.setAttribute("qnaList", list);
		request.setAttribute("sortOption", sortOption);
		
		request.getRequestDispatcher("views/member/myPage/myQna.jsp").forward(request, response);
	}
