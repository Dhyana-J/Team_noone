...
public class MyReviewController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		listCount = new MemberService().selectMyReviewCount(userNo);
		...
		ArrayList<MyReview> list = new MemberService().selectMyReviewList(userNo,pi,sortOption);
		
		request.setAttribute("pi", pi);
		request.setAttribute("reviewList", list);
		request.setAttribute("sortOption", sortOption);
		
		request.getRequestDispatcher("views/member/myPage/myReview.jsp").forward(request, response);
	}
