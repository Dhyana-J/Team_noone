...
/**
 * Servlet implementation class ThumbnailListViewController
 */
@WebServlet("/thumbnailList.bo")
public class ThumbnailListViewController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ThumbnailListViewController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		listCount = new BoardService().selectThListCount();
		...
		request.getRequestDispatcher("views/community/thumbnailListView.jsp").forward(request, response);
