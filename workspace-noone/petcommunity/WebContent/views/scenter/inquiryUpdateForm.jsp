	 ...
	 <div class="wrapper">
      ...
      <div class="main">
        ...
        <div class='content'>
          ...
          <form action="<%=contextPath %>/update.inq" id="enrollForm_cn" method="POST" >
          
           	 <br>
          	카테고리선택 : 
          	<%if(i.getInquiryType().equals("상품문의")){ %>
           	...
           	<%}else if(i.getInquiryType().equals("교환/환불")){ %>
	           	<select name="category">
	            <option value="상품문의">상품문의</option>
	            <option value="교환/환불" selected>교환/환불</option>
	            <option value="게시판">게시판</option>
	            <option value="배송문의">배송문의</option>
	          	</select>
          	<%}else if(i.getInquiryType().equals("게시판")){%>
          		<select name="category">
	            <option value="상품문의">상품문의</option>
	            <option value="교환/환불">교환/환불</option>
          	...
          	<%} %>
			<input type = hidden name="ino" value="<%=i.getInquiryNo()%>">
            <table align="center">
                <tr>
                    <th class="cnth">제목</th>
                    <td width="300"><input type="text" name="title" required value="<%=i.getInquiryTitle()%>"></td>

                </tr>
                <tr>
                    <th class="cnth">내용</th>
                    <td><textarea name="content" rows="13" required style="resize:none"><%=i.getInquiryContent() %></textarea></td>
                </tr>
            </table>
            <br><br>
