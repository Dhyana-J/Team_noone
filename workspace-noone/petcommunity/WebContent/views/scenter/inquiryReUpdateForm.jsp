	 ...
	 <div class="wrapper">
      ...
      <div class="main">
        ...
        <div class='content'>
          ...
          <form action="<%=contextPath %>/reUpdate.inq" id="enrollForm_cn" method="POST" >          
			<input type="hidden" name="ino" value=<%=i.getInquiryNo() %> >
            <table align="center">
                
                <tr>
                    <th class="cnth">답변내용</th>
                    <td><textarea name="content" rows="13" required style="resize:none"><%=i.getReContent() %></textarea></td>
                </tr>
            </table>
            <br><br>
