<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import = "com.kh.scenter.model.vo.Faq"%>
<%
      ...
      <div class="main">
        ...
        <div class='content'>          
            ...
            <table align="center" id="list_area_w">
                ...
                <tbody>
                <tr>
                    <th><textarea name="content" cols="50" rows="5" style="resize: none;"><%=f.getFaqContent() %></textarea></th>
                    <td><textarea name="answer" cols="50" rows="5" style="resize: none;"><%=f.getFaqAnswer() %></textarea></td><br>
