...
<div id="commentWrite">
        ...
        <form action="<%=context %>/reviewUpdate.st" method="post" id="commentWrite_form" align="center">            
            <input type="hidden" name="reviewNo" value="<%=review.getReviewNO()%>"> 
            <input type="hidden" name="userNo" value="<%=loginUser.getUserNo()%>">
            <input type="hidden" name="pNo" value="<%=review.getpNo()%>">
            <!-- 후기내용  -->
            <table>
                <tr>
                    <th width="100px">작성자</th>
                    <td><input style="width: 100px;" type="text" name="uerName" id="uerName" value="<%=review.getUserName() %>" disabled></td>
                ...
                <tr>
                    <th>제목</th>
                    <td><input style="width: 200px;" type="text" name="reviewTitle" value="<%=review.getReviewTitle()%>"></td>

                </tr>
                <tr>
                    <th>후기</th>
                    <td><textarea style="resize:none" name="reivewContent" cols="50" rows="13" required><%=review.getReviewContent()%></textarea></td>
                </tr>
            ...
            <div id="commentWrite_btn">
                <button id="b" type="submit" disabled> 수정하기</button>
            </div>
        </form>
    </div>
<script>
$(function(){
	...
	$(function(){
		$("#commentWrite_form option").each(function(){
			if($(this).val() == "<%=review.getReviewRating()%>"){
