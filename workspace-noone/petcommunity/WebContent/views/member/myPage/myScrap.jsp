...
#myScrap{display:block !important;}

/*현재 보고있는 메뉴 색상 표시!*/
.sideBar .subMenu:nth-child(4) *{color:tomato;}
.sideBar .subMenuList li:nth-child(1) *{color:blue;}
</style>
</head>
<body>
    <div class="wrapper">
				          ...
				          <div class="myArticlesWrap">
					            ...
					            <form action="" method="post">
					              <select name="sortOption" id="sortSelect">
					                ...
					                <option value="1month">과거순</option>
					                <option value="3month">가나다순</option>
					              </select>
					            </form>
