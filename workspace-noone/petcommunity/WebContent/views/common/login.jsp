            ...
            <form action="<%=contextPath%>/login.me" method="post">
              <table>
                ...
                <tr>
                  ...
                  <td>
                    <button type="button" class="btn btn-primary" onclick="location.href='<%=contextPath %>/findForm.id'">ID찾기</button>
                  </td>
                  <td>
                    <button type="button" class="btn btn-primary" onclick="location.href='<%=contextPath %>/findForm.pwd'">PW찾기</button>
                  </td>
                </tr>
              </table>
            </form>
